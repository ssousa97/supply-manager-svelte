<script lang="ts">
	...
	function removeItem(currentItem: Item) {
				...
				<svelte:fragment slot="content">
					...
					<div class="flex gap-x-2">
						<label for="" class="label">
							...
							<input type="number" min="0" class="input rounded-md" bind:value={item.totalUnits} />
						</label>
						<label for="" class="label">
							<span class="text-sm">Quantidade por unidade</span>
							<input type="number" min="0" class="input rounded-md" bind:value={item.amountPerUnit} />
						</label>
						<label for="" class="label">
							<span class="text-sm">Preço por unidade</span>
							<input type="number" min="0" class="input rounded-md" bind:value={item.pricePerUnit} />
						</label>
					</div>
